...
int main() {
	...
	while (1) { // 사용자에게 계속 입력받기 위해 무한 루프
        ...
        if (!checkUser(magician) || !checkUser(warrior)) { // firstUser의 hp값이 0인지 체크하는 함수를 통해 확인
		...
		cout << "현재 HP: " << firstUser.GetHP() << "  명령어를 입력하세요 (up,down,left,right,information,map,end): ";
		cin >> user_input;
